                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-800 mb-4">Create an Account!</h1>
                                <?php
                            ...
                            <form class="user" method="POST" action="registermain.php">
                                ...
                                <button type="submit" name="save_data" class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </button>
                                <hr>
